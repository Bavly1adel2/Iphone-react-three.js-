...
const Model = React.forwardRef((_, ref) => {
    const { scene } = useGLTF('iphone_16_pro_max.glb'); // Adjust the path to your model
...
const ModelViewer = () => {
            ...
            gsap.fromTo(modelRef.current.position,
                ...
                { y: 0, duration: 2, ease: 'bounce.out',
                    scrollTrigger: {
                        ...
                        end: 'top 20%', // End when the model is at 20% of the viewport height
    ...
    return (
        <Canvas
            style={{ height: '100vh', width: '100%', position: 'absolute', zIndex: 1, left: -450 }} // Responsive full screen height
